      ...
      <div className="col-md-60 col-lg-4 col-xl-4 order-0 mb-4">
        ...
        <div className="card h-100">
          ...
          <div className="card-body">
              <button onClick={handleModeToggle} className="mt-2 px-4 py-1 rounded text-white bg-blue-400">
        ...
        <div className="col-lg-4 col-md-4 order-1">
            <div className="row">
              ...
              <div className="col-12 mb-4">
                <div className="card">
                  <div className="card-body">
                    <h5 className="text-nowrap mb-2">Temperature Graph</h5>
              ...
              <div className="col-6 mb-4">
                <div className="card">
                  <div className="card-body">
                    ...
                    <small className="text-success fw-semibold"><i className="bx bx-up-arrow-alt"></i> GOOD</small>
                  </div>
                </div>
              </div>
